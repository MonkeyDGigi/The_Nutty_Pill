  ...
  <q-drawer v-model="leftDrawerOpen" bordered>
    <q-list>
      <q-item clickable @click="navigateToHome">
        ...
        <q-item-section>
          <q-item-label>The Nutty Pill</q-item-label>
          <q-item-label caption>Go to learning home</q-item-label>
        </q-item-section>
      </q-item>
      <q-separator spaced />
      <q-item-label header>My Wallet</q-item-label>
      <q-item clickable to="/wallet">
        ...
        <q-item-section>
          ...
          <q-item-label caption>View balance and send/receive</q-item-label>
        </q-item-section>
      </q-item>
      <q-item clickable to="/history">
        ...
        <q-item-section>
          ...
          <q-item-label caption>View transaction history</q-item-label>
        </q-item-section>
      </q-item>
      ...
      <q-item clickable to="/theme">
        <q-item-section avatar>
          <q-icon name="palette" />
        </q-item-section>
        <q-item-section>
          <q-item-label>Theme</q-item-label>
          <q-item-label caption>Change app appearance</q-item-label>
        </q-item-section>
      </q-item>
      <q-item-label header>{{
...
/* Remove borders from header buttons */
.q-header .q-btn,
.q-toolbar .q-btn {
