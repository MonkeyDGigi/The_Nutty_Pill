<template>
  <div class="bg-dark text-white text-center q-pa-md flex flex-center">
    <!-- Password Protection -->
    <div v-if="!isAuthenticated" style="max-width: 400px; width: 100%;">
      <q-card class="q-pa-md">
        <q-card-section>
          <div class="text-h6 q-mb-md">Admin Access Required</div>
          <div v-if="!hasPassword">
            <div class="text-body2 q-mb-md">
              Set up a password to access admin controls and wallet settings.
            </div>
            <q-input
              v-model="newPassword"
              type="password"
    ...
    <SettingsView v-else :authenticated="isAuthenticated" />
  </div>
</template>
