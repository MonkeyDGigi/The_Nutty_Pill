export default {
  ...
  WelcomeSlide1: {
    title: "Welcome to The Nutty Pill",
    text: "The Nutty Pill is an orange pilling project based on the Cashu.me wallet. Help your friends and family learn about Bitcoin while getting some sats!",
    actions: {
      more: {
